...
public static partial class EnsureBuilderExtensions
{
    ...
    /// <returns>An ensure builder that validates the value is greater than the minimum.</returns>
    ...
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the value is greater than or equal to the minimum.</returns>
    ...
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the value is less than the maximum.</returns>
    ...
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the value is less than or equal to the maximum.</returns>
    ...
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the value is within the specified range.</returns>
    ...
    /// <param name="ensure">The ensure builder for the numeric value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the value is positive.</returns>
    ...
    /// <param name="ensure">The ensure builder for the numeric value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the value is negative.</returns>
    ...
    /// <param name="ensure">The ensure builder for the numeric value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the value is not zero.</returns>
    ...
    /// <param name="ensure">The ensure builder for the numeric value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the value is non-positive.</returns>
    ...
    /// <param name="ensure">The ensure builder for the numeric value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the value is non-negative.</returns>
