...
public static partial class EnsureBuilderExtensions
{
    ...
    /// <returns>An ensure builder that validates the DateTime is after the current time.</returns>
    ...
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the DateOnly is after the current date.</returns>
    ...
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the TimeOnly is after the current time.</returns>
    ...
    /// <param name="ensure">The ensure builder for the DateTime value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the DateTime is before the current time.</returns>
    ...
    /// <param name="ensure">The ensure builder for the DateOnly value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the DateOnly is before the current date.</returns>
    ...
    /// <param name="ensure">The ensure builder for the TimeOnly value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the TimeOnly is before the current time.</returns>
    ...
    /// <param name="ensure">The ensure builder for the DateOnly value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the DateOnly is on or after the current date.</returns>
    ...
    /// <param name="ensure">The ensure builder for the DateOnly value.</param>
    /// <param name="error">Optional custom error. If null, a default error message will be used.</param>
    /// <returns>An ensure builder that validates the DateOnly is on or before the current date.</returns>
