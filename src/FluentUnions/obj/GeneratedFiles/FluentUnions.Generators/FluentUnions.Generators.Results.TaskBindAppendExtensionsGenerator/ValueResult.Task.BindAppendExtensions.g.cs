...
{
    public static async Task<Result<(TSource, TTarget)>> BindAppendAsync<TSource, TTarget>(
    ...
    public static async Task<Result<(TSource, TTarget1, TTarget2)>> BindAppendAsync<TSource, TTarget1, TTarget2>(
        this Result<TSource> result,
        Func<TSource, Task<Result<(TTarget1, TTarget2)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TTarget)>> BindAppendAsync<TSource1, TSource2, TTarget>(
        this Result<(TSource1, TSource2)> result,
        Func<TSource1, TSource2, Task<Result<TTarget>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource, TTarget1, TTarget2, TTarget3)>> BindAppendAsync<TSource, TTarget1, TTarget2, TTarget3>(
        this Result<TSource> result,
        Func<TSource, Task<Result<(TTarget1, TTarget2, TTarget3)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TTarget1, TTarget2)>> BindAppendAsync<TSource1, TSource2, TTarget1, TTarget2>(
        this Result<(TSource1, TSource2)> result,
        Func<TSource1, TSource2, Task<Result<(TTarget1, TTarget2)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TTarget)>> BindAppendAsync<TSource1, TSource2, TSource3, TTarget>(
        this Result<(TSource1, TSource2, TSource3)> result,
        Func<TSource1, TSource2, TSource3, Task<Result<TTarget>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource, TTarget1, TTarget2, TTarget3, TTarget4)>> BindAppendAsync<TSource, TTarget1, TTarget2, TTarget3, TTarget4>(
        this Result<TSource> result,
        Func<TSource, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TTarget1, TTarget2, TTarget3)>> BindAppendAsync<TSource1, TSource2, TTarget1, TTarget2, TTarget3>(
        this Result<(TSource1, TSource2)> result,
        Func<TSource1, TSource2, Task<Result<(TTarget1, TTarget2, TTarget3)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TTarget1, TTarget2)>> BindAppendAsync<TSource1, TSource2, TSource3, TTarget1, TTarget2>(
        this Result<(TSource1, TSource2, TSource3)> result,
        Func<TSource1, TSource2, TSource3, Task<Result<(TTarget1, TTarget2)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TTarget)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TTarget>(
        this Result<(TSource1, TSource2, TSource3, TSource4)> result,
        Func<TSource1, TSource2, TSource3, TSource4, Task<Result<TTarget>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5)>> BindAppendAsync<TSource, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5>(
        this Result<TSource> result,
        Func<TSource, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4, TTarget5)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TTarget1, TTarget2, TTarget3, TTarget4)>> BindAppendAsync<TSource1, TSource2, TTarget1, TTarget2, TTarget3, TTarget4>(
        this Result<(TSource1, TSource2)> result,
        Func<TSource1, TSource2, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TTarget1, TTarget2, TTarget3)>> BindAppendAsync<TSource1, TSource2, TSource3, TTarget1, TTarget2, TTarget3>(
        this Result<(TSource1, TSource2, TSource3)> result,
        Func<TSource1, TSource2, TSource3, Task<Result<(TTarget1, TTarget2, TTarget3)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TTarget1, TTarget2)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TTarget1, TTarget2>(
        this Result<(TSource1, TSource2, TSource3, TSource4)> result,
        Func<TSource1, TSource2, TSource3, TSource4, Task<Result<(TTarget1, TTarget2)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TSource5, TTarget)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TSource5, TTarget>(
        this Result<(TSource1, TSource2, TSource3, TSource4, TSource5)> result,
        Func<TSource1, TSource2, TSource3, TSource4, TSource5, Task<Result<TTarget>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5, TTarget6)>> BindAppendAsync<TSource, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5, TTarget6>(
        this Result<TSource> result,
        Func<TSource, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4, TTarget5, TTarget6)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5)>> BindAppendAsync<TSource1, TSource2, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5>(
        this Result<(TSource1, TSource2)> result,
        Func<TSource1, TSource2, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4, TTarget5)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TTarget1, TTarget2, TTarget3, TTarget4)>> BindAppendAsync<TSource1, TSource2, TSource3, TTarget1, TTarget2, TTarget3, TTarget4>(
        this Result<(TSource1, TSource2, TSource3)> result,
        Func<TSource1, TSource2, TSource3, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TTarget1, TTarget2, TTarget3)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TTarget1, TTarget2, TTarget3>(
        this Result<(TSource1, TSource2, TSource3, TSource4)> result,
        Func<TSource1, TSource2, TSource3, TSource4, Task<Result<(TTarget1, TTarget2, TTarget3)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TSource5, TTarget1, TTarget2)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TSource5, TTarget1, TTarget2>(
        this Result<(TSource1, TSource2, TSource3, TSource4, TSource5)> result,
        Func<TSource1, TSource2, TSource3, TSource4, TSource5, Task<Result<(TTarget1, TTarget2)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TTarget)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TTarget>(
        this Result<(TSource1, TSource2, TSource3, TSource4, TSource5, TSource6)> result,
        Func<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, Task<Result<TTarget>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5, TTarget6, TTarget7)>> BindAppendAsync<TSource, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5, TTarget6, TTarget7>(
        this Result<TSource> result,
        Func<TSource, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4, TTarget5, TTarget6, TTarget7)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5, TTarget6)>> BindAppendAsync<TSource1, TSource2, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5, TTarget6>(
        this Result<(TSource1, TSource2)> result,
        Func<TSource1, TSource2, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4, TTarget5, TTarget6)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5)>> BindAppendAsync<TSource1, TSource2, TSource3, TTarget1, TTarget2, TTarget3, TTarget4, TTarget5>(
        this Result<(TSource1, TSource2, TSource3)> result,
        Func<TSource1, TSource2, TSource3, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4, TTarget5)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TTarget1, TTarget2, TTarget3, TTarget4)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TTarget1, TTarget2, TTarget3, TTarget4>(
        this Result<(TSource1, TSource2, TSource3, TSource4)> result,
        Func<TSource1, TSource2, TSource3, TSource4, Task<Result<(TTarget1, TTarget2, TTarget3, TTarget4)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TSource5, TTarget1, TTarget2, TTarget3)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TSource5, TTarget1, TTarget2, TTarget3>(
        this Result<(TSource1, TSource2, TSource3, TSource4, TSource5)> result,
        Func<TSource1, TSource2, TSource3, TSource4, TSource5, Task<Result<(TTarget1, TTarget2, TTarget3)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TTarget1, TTarget2)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TTarget1, TTarget2>(
        this Result<(TSource1, TSource2, TSource3, TSource4, TSource5, TSource6)> result,
        Func<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, Task<Result<(TTarget1, TTarget2)>>> binder)
    {
        if (result.IsFailure) return result.Error;
    ...
    public static async Task<Result<(TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TTarget)>> BindAppendAsync<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TTarget>(
        this Result<(TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7)> result,
        Func<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, Task<Result<TTarget>>> binder)
    {
        if (result.IsFailure) return result.Error;
