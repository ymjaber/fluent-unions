...
{
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TTarget>(
        this Option<(TValue1, TValue2)> source,
    ...
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TTarget>(
        this Option<(TValue1, TValue2, TValue3)> source,
    ...
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, ValueTask<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TTarget>(
        this Option<(TValue1, TValue2, TValue3, TValue4)> source,
    ...
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, TValue4, ValueTask<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TTarget>(
        this Option<(TValue1, TValue2, TValue3, TValue4, TValue5)> source,
    ...
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, ValueTask<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TTarget>(
        this Option<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6)> source,
    ...
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, ValueTask<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TTarget>(
        this Option<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7)> source,
    ...
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, ValueTask<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async ValueTask<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8, TTarget>(
        this Option<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8)> source,
