...
{
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TTarget>(
    ...
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TTarget>(
    ...
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, Task<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TTarget>(
    ...
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, TValue4, Task<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TTarget>(
    ...
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, Task<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TTarget>(
    ...
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, Task<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TTarget>(
    ...
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TTarget>(
        ...
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, Task<TTarget>> mapper)
        => await (await source.ConfigureAwait(false)).MapAsync(mapper).ConfigureAwait(false);
    public static async Task<Option<TTarget>> MapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8, TTarget>(
