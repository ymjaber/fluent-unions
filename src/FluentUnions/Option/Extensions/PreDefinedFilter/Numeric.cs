...
public static partial class FilterBuilderExtensions
{
    ...
    /// <returns>A filter builder that validates the value is greater than the minimum.</returns>
    ...
    /// <returns>A filter builder that validates the value is greater than or equal to the minimum.</returns>
    ...
    /// <returns>A filter builder that validates the value is less than the maximum.</returns>
    ...
    /// <returns>A filter builder that validates the value is less than or equal to the maximum.</returns>
    ...
    /// <returns>A filter builder that validates the value is within the specified range.</returns>
    ...
    /// <typeparam name="TValue">The type of the numeric value.</typeparam>
    /// <param name="filter">The filter builder for the numeric value.</param>
    /// <returns>A filter builder that validates the value is positive.</returns>
    ...
    /// <typeparam name="TValue">The type of the numeric value.</typeparam>
    /// <param name="filter">The filter builder for the numeric value.</param>
    /// <returns>A filter builder that validates the value is negative.</returns>
    ...
    /// <typeparam name="TValue">The type of the numeric value.</typeparam>
    /// <param name="filter">The filter builder for the numeric value.</param>
    /// <returns>A filter builder that validates the value is not zero.</returns>
    ...
    /// <typeparam name="TValue">The type of the numeric value.</typeparam>
    /// <param name="filter">The filter builder for the numeric value.</param>
    /// <returns>A filter builder that validates the value is non-positive.</returns>
    ...
    /// <typeparam name="TValue">The type of the numeric value.</typeparam>
    /// <param name="filter">The filter builder for the numeric value.</param>
    /// <returns>A filter builder that validates the value is non-negative.</returns>
